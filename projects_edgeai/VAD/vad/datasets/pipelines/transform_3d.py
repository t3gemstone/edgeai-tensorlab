...
class CustomObjectRangeFilter(BaseTransform):
...
@TRANSFORMS.register_module()
class CustomObjectNameFilter(BaseTransform):
...
@TRANSFORMS.register_module()
class VADPack3DDetInputs(Pack3DDetInputs):
    def __init__(
            self,
            keys: tuple,
        ...
        super(VADPack3DDetInputs, self).__init__(keys, meta_keys)
