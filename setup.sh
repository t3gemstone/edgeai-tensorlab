...
readonly TITLE="🚀 T3 Gemstone Vision Process Model Development Kit"
...
readonly DESCRIPTION=$(
    cat <<EOF
  This script downloads and installs the necessary packages 📦 to develop the vision process model for T3 Gemstone boards.
