...
class YOLOXHeadCustom(BaseDenseHead):
    ...
    def __init__(self,
                 ...
                 loss_centers2d=dict(type='mmdet.L1Loss', reduction='sum', loss_weight=1.0),
                 train_cfg=None,
                 test_cfg=None,
                 init_cfg=dict(
                     type='Kaiming',
        ...
        if pred_with_depth:
            self.loss_depth2d = MODELS.build(loss_depth2d)    # deprecated
